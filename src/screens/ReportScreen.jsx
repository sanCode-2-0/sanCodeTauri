  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <>
          <p>
            Students with <b>fever</b> : {studentAilmentCounts.fever} ( This
            represents counting stuff like redirects to and fro - Those
            redirects should either have a value or be null){" "}
          </p>
          <p>
            No of records with <b>temperature readings present</b> :{" "}
            {tempReadingPresent}
          </p>
          <hr />
