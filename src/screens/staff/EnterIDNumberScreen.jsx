...
const EnterIDNumberScreen = () => {
  ...
  const fetchIdNumber = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3000/staff/${idNo}`);
          ...
          <div className="col l12 section main">
            <div className="card light-blue darken-1">
              ...
              <div className="card-action center-align">
                <a className="modal-trigger" href="#enter-id-number-modal">
                  <button
                  ...
                  {fName !== "" ? (
                    <>
                      <div className="modal-content bottom-sheet left-align">
                        ...
                        <br />
                        <small>
                          * Full Entry : Create a new record for the staff
                          member
                        </small>
                        <br />
                        <small>
                    ...
                    <>
                      <div className="modal-content">
                        <blockquote>
                          NO RECORD MATCHING THAT ID NUMBER <b>({idNo})</b>{" "}
                          FOUND!
                        </blockquote>
                        <p>{fName}</p>
                      </div>
